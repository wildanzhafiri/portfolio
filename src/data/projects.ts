...
export const projects: Project[] = [
  {
    ...
    thumbnail: `${BASE}projects/bulkyhub/bulkyhub-landingpage.webp`,
    images: [
      `${BASE}projects/bulkyhub/bulkyhub-landingpage.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-form.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-formdetail.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-verif.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-uploadproof.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-track.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-loginadmin.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-dashboard.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-pickuprequest.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-schedule.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-assignment.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-detailassignment.webp`,
      `${BASE}projects/bulkyhub/bulkyhub-truckmanagement.webp`,
    ],
  ...
  },
  {
    ...
    role: 'Front-end Developer',
    thumbnail: `${BASE}projects/laporin/laporin1.webp`,
    images: Array.from({ length: 10 }, (_, i) => `${BASE}projects/laporin/laporin${i + 1}.webp`),
    techStack: ['React', 'TypeScript', 'Tailwind', 'REST API'],
    features: [
  ...
  },
  {
    ...
    role: 'Front-end Developer',
    thumbnail: `${BASE}projects/em/em1.webp`,
    images: Array.from({ length: 11 }, (_, i) => `${BASE}projects/em/em${i + 1}.webp`),
  ...
  },
  {
    ...
    role: 'Front-end Developer',
    thumbnail: `${BASE}projects/kenalbatik/kenakbatik1.webp`,
    images: [
      ...Array.from({ length: 7 }, (_, i) => `${BASE}projects/kenalbatik/kenakbatik${i + 1}.webp`),
      ...Array.from({ length: 4 }, (_, i) => `${BASE}projects/kenalbatik/kenalbatik${i + 8}.webp`),
    ],
  ...
  },
  {
    ...
    role: 'Front-end Developer',
    thumbnail: `${BASE}projects/ticketbuzz/ticketbuzz1.webp`,
    images: [
      `${BASE}projects/ticketbuzz/ticketbuzz1.webp`,
      `${BASE}projects/ticketbuzz/ticketbuzz4.webp`,
      `${BASE}projects/ticketbuzz/ticketbuzz2.webp`,
      `${BASE}projects/ticketbuzz/ticketbuzz3.webp`,
      `${BASE}projects/ticketbuzz/ticketbuzz5.webp`,
      `${BASE}projects/ticketbuzz/ticketbuzz6.webp`,
      `${BASE}projects/ticketbuzz/ticketbuzz7.webp`,
    ],
  ...
  },
  {
    ...
    role: 'Front-end Developer',
    thumbnail: `${BASE}projects/lentara/lentara1.webp`,
    images: Array.from({ length: 10 }, (_, i) => `${BASE}projects/lentara/lentara${i + 1}.webp`),
  ...
  },
  {
    ...
    role: 'Front-end Developer',
    thumbnail: `${BASE}projects/domma/domma1.webp`,
    images: [
      `${BASE}projects/domma/domma1.webp`,
      `${BASE}projects/domma/domma2.webp`,
      `${BASE}projects/domma/domma3.webp`,
      `${BASE}projects/domma/domma4.webp`,
      `${BASE}projects/domma/domma5.webp`,
      `${BASE}projects/domma/domma6.webp`,
      `${BASE}projects/domma/domma9.webp`,
      `${BASE}projects/domma/domma10.webp`,
      `${BASE}projects/domma/domma11.webp`,
      `${BASE}projects/domma/domma12.webp`,
      `${BASE}projects/domma/domma13.webp`,
      `${BASE}projects/domma/domma7.webp`,
      `${BASE}projects/domma/domma8.webp`,
    ],
